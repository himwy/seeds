          ...
          <div className="container mx-auto px-6 text-center">
            <div className="max-w-lg mx-auto">
              <div className="flex justify-center mb-8">
                <div className="p-3 bg-white bg-opacity-20 backdrop-blur-sm rounded-lg border border-white border-opacity-30">
                  <Image
              ...
              <h1 className="text-3xl font-semibold mb-6 text-white leading-tight">
                {t.introduction.title}
              </h1>
              <div className="bg-white bg-opacity-10 backdrop-blur-sm p-6 rounded-lg border border-white border-opacity-30">
        ...
        <section className="py-12 px-6 bg-white w-full">
          ...
          <div className="space-y-4">
            {t.mission.points.map((point, index) => (
              <div
                key={index}
                className="bg-white p-4 border-l-4 border-blue-600 shadow-sm"
              >
            ...
            {t.philosophy.circles.map((circle, index) => (
              ...
              >
                <div className="flex items-start mb-3">
                  <div className="mr-3 flex-shrink-0 w-10 h-10 flex items-center justify-center border border-gray-200 bg-gray-50 rounded-lg">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <div className="flex justify-center mb-12">
                <div className="p-6 bg-white bg-opacity-20 backdrop-blur-sm rounded-lg border border-white border-opacity-30">
                  <Image
                    src="/assets/Seeds_Icon_Trans.png"
                    alt="Seeds Financial Group Logo"
                    width={100}
              ...
              <h1 className="text-4xl md:text-5xl font-semibold mb-8 text-white text-center">
                {t.introduction.title}
              </h1>
              <div className="bg-white bg-opacity-10 backdrop-blur-sm p-8 rounded-lg border border-white border-opacity-30 max-w-3xl mx-auto">
                <p className="text-white mb-6 text-lg leading-relaxed">
                  {t.introduction.description1}
                </p>
                <div className="w-16 h-px bg-white bg-opacity-50 mx-auto mb-6"></div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 mb-8">
              {t.mission.points.map((point, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="bg-white p-6 border-l-4 border-blue-600 shadow-sm hover:shadow-md transition-shadow duration-200"
                >
                  <div className="flex items-start">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-blue-50 p-8 border border-blue-200 rounded-lg text-center"
            >
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {t.values.items.map((value, index) => (
                <motion.div
                  ...
                  transition={{ duration: 0.5, delay: index * 0.1 }}
                  viewport={{ once: true }}
                  className="bg-white p-6 border border-gray-200 hover:border-blue-300 transition-colors duration-200 rounded-lg"
                >
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="w-16 h-px bg-blue-600 mx-auto mb-6"></div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {t.philosophy.circles.map((circle, index) => (
                ...
                >
                  <div className="text-center">
                    <div className="mb-4 inline-flex p-3 bg-gray-50 rounded-lg">
                      {React.createElement(philosophyIcons[index].icon, {
