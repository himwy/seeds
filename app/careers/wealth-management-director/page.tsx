...
const translations = {
  en: {
    ...
    applyDescription:
      "Send us your resume and cover letter to start your journey with us.",
    applyNow: "Apply Now",
    ...
    benefits: [
      {
        ...
        description:
          "Take on a senior role with autonomy to shape our wealth management division's future.",
      },
      {
        title: "Professional Growth",
        description:
          "Access to ongoing training, mentorship, and career advancement opportunities.",
      },
      {
        title: "Competitive Compensation",
        description:
          "Attractive salary package with performance bonuses and high commission potential.",
      },
      {
        title: "Work-Life Balance",
        description:
          "A supportive environment that values your well-being and personal growth.",
      },
    ],
  },
  "zh-HK": {
