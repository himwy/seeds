    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          content: "With years of experience working in this industry, Wendy understood what the wife was going through and she was sympathetic to her situation. The wife was not the first client, nor she would be the last client who went out of her mind in case of critical circumstances. Wendy knew that all they needed was more care and professional service. She didn't argue with the wife regarding the claiming procedures because it would not be very helpful considering the circumstances back then. A few weeks later, a one million HKD cheque was handed to the couple, the case was settled."
        }
      ]
    },
    {
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Professional insights and educational analysis through real-world financial scenarios
          </p>
        </motion.div>
            ...
            <div className="p-6">
              {study.sections.map((section, index) => (
                <motion.div
                  ...
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.6, delay: (studyIndex * 0.2) + (index * 0.1) }}
                  className={`${index !== study.sections.length - 1 ? 'mb-8 pb-8 border-b border-gray-100' : 'mb-0'}`}
                >
        ...
        >
          <div className="bg-white border border-gray-200 rounded-lg p-8 shadow-sm">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Learn More About Our Services</h2>
            <p className="text-gray-700 mb-6 max-w-2xl mx-auto">
              These case studies demonstrate our expertise in financial planning and risk management. 
