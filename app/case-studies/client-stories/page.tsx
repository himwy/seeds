      ...
      items: [
        {
          ...
          content:
            "Seeds Financial Group transformed our family's approach to wealth management. Their holistic strategy and personalized service exceeded our expectations.",
          rating: 5,
        ...
        },
        {
          ...
          content:
            "The team's expertise in succession planning helped us navigate a complex multi-generational transition seamlessly. Truly professional service.",
          rating: 5,
        ...
        },
        {
          ...
          content:
            "Their ESG investment approach aligns perfectly with our family values while delivering exceptional returns. Outstanding partnership.",
          rating: 5,
      ...
      stories: [
        {
          ...
          challenge:
            "Managing $200M liquidity event and establishing family office structure",
          solution:
            "Comprehensive wealth management strategy with tax-efficient structures",
          results: [
        ...
        },
        {
          ...
          challenge:
            "Succession planning for $500M family business with 15 family members",
          solution:
            "Structured succession plan with family governance and professional management",
          results: [
        ...
        },
        {
          ...
          challenge:
            "Balancing financial returns with social impact across $100M portfolio",
          solution:
            "ESG-focused investment strategy with impact measurement framework",
          results: [
      ...
      items: [
        {
          ...
          company: "陳氏家族辦公室",
          content:
            "Seeds Financial Group 改變了我們家族的財富管理方式。他們的整體策略和個性化服務超出了我們的期望。",
          rating: 5,
          image: "/assets/client-1.jpg",
        },
        {
          ...
          company: "羅德里格斯企業",
          content:
            "團隊在接班規劃方面的專業知識幫助我們順利完成了複雜的多代傳承。真正專業的服務。",
          rating: 5,
          image: "/assets/client-2.jpg",
        },
        {
          ...
          company: "王氏家族基金會",
          content:
            "他們的ESG投資方法與我們的家族價值觀完美契合，同時帶來了卓越的回報。傑出的合作夥伴關係。",
          rating: 5,
          image: "/assets/client-3.jpg",
        },
      ],
    ...
    feedback: {
      ...
      categories: [
        ...
        },
        {
          title: "家族治理",
          score: 4.9,
          comments: ["有效的衝突解決", "清晰的溝通", "教育計劃", "下一代參與"],
        },
      ],
    },
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <div className="flex justify-center mb-4">
                      {[
                        ...Array(
                          t.testimonials.items[currentTestimonial].rating
                        ),
                      ].map((_, i) => (
