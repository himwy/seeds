...
const translations = {
  en: {
    ...
    experienceText:
      "With more than two decades in senior management roles, Bella has demonstrated exceptional decision-making skills and leadership, driving sustained performance growth while earning a stellar reputation within the industry.",

    transitionTitle: "New Chapter at AIA",
    transitionText:
      "Now, Bella embarks on an exciting new chapter by joining AIA Hong Kong and Seeds Financial Group to pursue a career in wealth management. Her decision reflects her deep appreciation for Hong Kong as a global financial hub. Bella recognizes Hong Kong's long-standing financial legacy, robust legal framework, and diversified investment products as key enablers for delivering global asset allocation solutions.",

    opportunityTitle: "Market Opportunity",
    opportunityText:
      "She sees immense potential in combining her expertise with the unique opportunities presented by Hong Kong's market, especially given the growing demand for wealth management and asset protection among high-net-worth individuals.",

    aiaTitle: "Why AIA & Seeds Financial Group",
    aiaText:
      "Bella chose AIA not only for its status as a global leader in life insurance but also for its innovative culture and comprehensive wealth management services. As a company with over a century of history, AIA offers a wide range of products, including family trusts, MPF, insurance, unit-linked funds, and education migration solutions. These offerings align perfectly with Bella's professional values and goals. Additionally, AIA and Seeds Financial Group's robust professional training and elite team support reinforced Bella's confidence in this platform as the ideal stage to further her career.",
  ...
  "zh-HK": {
    ...
    experienceText:
      "擁有超過二十年的高級管理經驗，Bella展現了卓越的決策能力和領導力，推動持續的業績增長，同時在行業內贏得了卓越的聲譽。",

    transitionTitle: "友邦新篇章",
    transitionText:
      "現在，Bella通過加入友邦香港和Seeds Financial Group開始了一個激動人心的新篇章，追求財富管理事業。她的決定反映了她對香港作為全球金融中心的深度讚賞。Bella認識到香港悠久的金融傳統、穩健的法律框架和多元化的投資產品是提供全球資產配置解決方案的關鍵因素。",

    opportunityTitle: "市場機遇",
    opportunityText:
      "她看到了將自己的專業知識與香港市場所呈現的獨特機遇相結合的巨大潛力，特別是考慮到高淨值人士對財富管理和資產保護日益增長的需求。",

    aiaTitle: "選擇友邦及Seeds Financial Group的原因",
    aiaText:
      "Bella選擇友邦不僅因為其作為全球人壽保險領導者的地位，還因為其創新文化和全面的財富管理服務。作為一家擁有超過一個世紀歷史的公司，友邦提供廣泛的產品，包括家族信託、強積金、保險、單位連結基金和教育移民解決方案。這些產品完全符合Bella的專業價值觀和目標。此外，友邦和Seeds Financial Group強大的專業培訓和精英團隊支持強化了Bella對這個平台作為進一步發展事業理想舞台的信心。",

    expertiseTitle: "跨學科專業知識",
    expertiseText:
      "作為銀行和財富管理領域的跨學科專家，Bella運用她敏銳的市場洞察力和對高淨值客戶需求的深刻理解，提供全面和個性化的財務規劃解決方案。她擅長風險分散、多資產配置和跨境財富規劃等策略，幫助客戶減輕市場波動並實現可持續的財富增長。",

    servicesTitle: "全面服務",
    servicesText:
      "Bella還強調重要服務，如代際財富轉移、婚姻和資產分離、稅務規劃和信託管理，以滿足高淨值人士的多方面需求。",

    visionTitle: "願景與承諾",
    visionText:
      "Bella將這次職業轉型視為新的專業挑戰和通過她獨特的專業知識和經驗組合為客戶提供更大價值的機會。她旨在將她的國內外洞察與香港全球連接的市場相結合，提供專業、創新和前瞻性的財富管理服務。通過與友邦和Seeds Financial Group的合作，Bella致力於幫助客戶實現財務目標，同時為團隊的成長和成功做出貢獻。她的到來為Seeds Financial Group團隊帶來了無與倫比的深度、願景和潛力。",
    ...
    >
      ...
      <article className="max-w-6xl mx-auto px-8 py-12">
        ...
        <section className="mb-16">
          <div className="max-w-4xl mx-auto">
            <div className="relative aspect-video bg-black rounded-lg overflow-hidden shadow-lg">
              <iframe
                src="https://www.youtube.com/embed/IfnR6P5o42k"
                title="Bella's Journey Joining AIA"
                frameBorder="0"
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-700 leading-relaxed mb-6">{t.servicesText}</p>
        </section>
