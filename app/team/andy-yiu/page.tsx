...
const translations = {
  ...
  "zh-HK": {
    ...
    intro: "Andy 在2022年一月正式加入AIA，來到Seeds Financial Group這一個大家庭。作為一個新進團隊的年輕人，經驗不多，卻滿腔熱情，希望分享一下自己入職AIA的經歷。",
    
    returningTitle: "回流香港",
    returningText: "Andy 在香港長大，在DSE畢業以後才遠赴瑞士讀書，大學時期主修款客服務業與活動管理，學士畢業後再攻讀款客服務業管理的碩士學位。完成學業後，Andy短暫的去了加拿大發展，唯發現香港有更多的機遇，於是決定回流香港。",
    
    hospitalityTitle: "酒店業的就業環境",
    hospitalityText1: "讀酒店的Andy 回來香港就去了當一家服務式住宅的服務員，那時他畢業後第一份全職工作。起初的工作他都覺得很有趣，有機會面對到不同的客人，和他們作互動以及交流，他認為認真的服務態度對他的工作以及與客人的關係都非常重要，他也是特別的享受這一種與人交流的工作性質。",
    
    hospitalityText2: "然而，漸漸的他察覺到他當時工作有幾個根本性的問題，讓他懷疑自己是否應該繼續留在該行業發展。第一，公司的晉升階梯非常的傳統，一般都要求員工有一定的年資和經驗才能晉升，比如說一個新入職的大學畢業生，要晉升到管理階級起碼要7-8年的年資，讓Andy覺得難以靠自己的努力爭取更多的上升空間。第二，工作內容過於重複，Andy漸漸覺得自己的工作沒有太大的挑戰性，能夠學到的實際東西也不多。一旦熟悉了酒店行業的一般流程以及工作內容，其實之後做的都是一樣的東西，這讓Andy開始失去當初對酒店業的興趣，也開始問自己是否願意未來就一直這樣的工作。第三，酒店業的工時很長，也經常需要輪班工作，很多時候週末也要去上班，令自己沒有了私人時間，對自己的生活節奏沒有掌控。而且行內嚴重的缺乏人手，Andy經常要一個人做兩到三個人的工作，工作量之不成正比讓他開始尋求更具挑戰性和彈性的工作。",
    
    opportunityTitle: "看到香港金融業的機會",
    opportunityText: "離開酒店業後，Andy積極的尋找他未來的發展方向，機緣使他認識到財務策劃以及AIA這一家香港保險業龍頭，以及行內成功的例子：Wendy和Mansfield。在一次與Wendy的面試之中，Wendy看到了Andy的滿腔拼勁，也察覺到了這位年輕人有發奮向上，為自己打拼的決心，於是跟他說：即時是千里馬也需要伯樂，在Wendy的眼中Andy就是一匹妥妥的千里馬，她有信心能夠把他培訓為一位出色、專業的財務策劃師。",
    
    aiaTitle: "關於AIA",
    aiaText: "入職以前Andy花了很多時間搜尋關於AIA的資料。他認為要進入財務策劃行業，就一定要加入最強的公司，因此AIA是他的絕對首選。Andy自己也有朋友在AIA工作，知道AIA的產品優質，本來就有很大的競爭優勢，也知道公司的資源很多，能讓他有足夠的把握選擇AIA。",
    
    futureTitle: "展望未來",
    futureText: "雖然是一個業界新人，但是Andy早已經下定決心要在這個行業取得成功。這一年劍指MDRT*和COT，他認為在這個行業要取得成功就必須有衝勁，他承諾不會讓自己失望或後悔。在未來的5年計畫裡面，Andy也希望能擁有自己的團隊，成為Leader，好讓自己能靠一雙手在行業裡面長期以及穩定的發展。",
