...
const translations = {
  ...
  "zh-HK": {
    ...
    backgroundText: "曾就讀理工大學全球供應鏈管理系，並在入行前擔任物流業的總經理一職，負責公司與客戶之間的協調與溝通。在這段工作經驗中，我學到了許多重要的價值觀，例如不以公司利益為首的中立立場，追求雙贏的局面，以及重視人與人之間的關係。這使Annie將許多客戶變成了朋友，建立了深厚的人際關係。",
    
    transitionTitle: "入行的原因",
    transitionText: "決定轉行投身保險業的原因源於Annie過去多次在中國內地和香港之間的奔波，並在一次東南亞出差中遇到突發疾病的情況。當時，感謝保險代理人的安排和協助，Annie能夠及時獲得適切的治療。這讓Annie深刻體會到保險的重要性，於是開始對保險業產生了興趣。Annie認識到保險業不僅能夠真正地為客戶著想，制定符合其需求的專屬計劃，而且也能滿足到她幫助他人的渴望。因此，annie決定在經過十年的大眾化工作後，轉行進入保險行業。",
    
    pandemicTitle: "疫情的影響",
    pandemicText: "疫情期間，Annie也深受其影響，無法自由出入境，被迫留在家中。然而，這段經歷讓她學會了變通的重要性，並體會到對他人的幫助是無價的。Annie開始思考如何突破自己的框架，並以無私的心態去幫助他人。在疫情期間，當她發現有多餘的物資時，她能夠立即伸出援手，無需期待回報，只是單純為了幫助他人。這段經歷讓她反思到過去的工作經驗和知識未能讓她在重大危機時候發揮作用，同時也意識到自己離開後沒有太多可以留給家人的東西。因此，Annie下定決心轉行，相信即使在她離開後，她仍然能夠幫助到家人。",
    
    futureTitle: "未來發展",
    futureText: "Annie計劃修讀碩士學位，不斷提升自己的專業能力。最近，她更獲得了調解員的證書，儘管這並不一定對其事業有直接幫助，但她相信「活到老，學到老」的理念，她會繼續進修，完成一直想做的事情。",
    
    goalsTitle: "短期發展",
    goalsText: "Annie希望能夠成功融入團隊，了解每位成員的專長，為未來的合作打下堅實的基礎。此外，Annie也懷抱著一個夢想，希望能夠創立兩個基金：動物基金和醫療基金。動物基金致力於照顧被虐待的動物，為牠們提供愛和庇護；而醫療基金則旨在改善現有的醫療體系，幫助那些無法負擔治療費用的人們。",
