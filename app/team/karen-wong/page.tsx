...
const translations = {
  ...
  "zh-HK": {
    ...
    intro: "Karen擁有深厚的法律背景，專注於家庭法與商業法，曾在資產保護、遺產規劃及法律爭議方面積累了豐富經驗。作為一名專業律師，她在解決複雜法律問題上以專業和細緻見稱，並深受客戶信任。",
    
    transformationTitle: "職業轉變",
    transformationText: "然而，在成為母親後，Karen的人生觀和職業規劃發生了轉變。她開始更加重視財富規劃的重要性，並意識到將法律與財富管理相結合能更全面地幫助客戶實現人生目標。這一啟發促使她加入友邦，成為我們的財富管理副總監，同時加入了Seeds Financial Group，專注於提供創新和多元化的解決方案。",
    
    expertiseTitle: "雙重專業",
    expertiseText1: "Karen的雙重專業背景使她能從法律和財務策劃的雙重視角出發，為客戶提供全方位的支持。她在Seeds Financial Group的團隊協作下，能進一步運用跨界專業知識，針對高淨值人士或專業人士面臨的財務挑戰。",
    
    expertiseText2: "結合法律策略與保險工具，幫助客戶降低法律訴訟風險、進行資產隔離及信託設立，確保財富安全。同時，她還注重通過遺囑和持久授權書的設立，為客戶應對突發情況提供保障。此外，她擁有出色的風險管理能力，善於幫助客戶分散投資風險，制定穩健而長遠的財富增值與傳承計劃，這些服務均與Seeds Financial Group的核心理念高度契合。",
    
    aiaTitle: "選擇友邦的原因",
    aiaText: "Karen加入友邦，主要看重其百年歷史與行業領導地位。她特別認同友邦前瞻性的創新文化，例如推出多元貨幣儲蓄計劃以及完善的一站式財富管理中心，這些優勢與她的專業理念不謀而合。同時，Seeds Financial Group作為一個充滿活力的財富管理平台，提供高度個性化的服務和專業培訓，為Karen的職業發展提供了雙重支持，進一步鞏固她的專業地位。",
    
    visionTitle: "願景與影響",
    visionText: "作為一位將法律專業與財富管理深度融合的跨界專家，Karen不僅致力於為客戶提供創新、高效的服務，也希望透過自身經驗啟發年輕一代，探索法律與財務策劃結合的無限可能，打造更具影響力的職業生涯。她的加入，為友邦與Seeds Financial Group的專業服務增添了新的深度與價值，也為我們的客戶創造了更多可能性。",
